...
##local_css(r"C:\Users\aligu\Desktop\else\portfolio\style.css")

#st.markdown('<style>' + '[data-testid="stVerticalBlock"]' + open('style.css').read() + '</style>', unsafe_allow_html=True)
...
with st.sidebar:
    with st.container():
        ...
        with l:
            st.empty()
        with m:
            img_lh = Image.open(r"C:\Users\aligu\Desktop\else\portfolio\images\image1c.jpg")
            st.image(img_lh, width=230)
        with r:
            st.empty()
    
    choose = option_menu(
    "Aly Guinga", 
    ["About Me", "Technical Skills", "Education", "Projects", "Competitions", "Volunteering", "Gallery", "Resume", "Contact"],
    icons=['person fill', 'tools', 'book half', 'clipboard', 'trophy fill', 'heart', 'image', 'paperclip', 'envelope'],
    menu_icon="mortarboard", 
    default_index=0,
    styles={
        "container": {"padding": "0!important", "background-color": "transparent"},  # Changed to transparent
        "icon": {"color": "darkorange", "font-size": "20px"}, 
        "nav-link": {
            "font-size": "17px", 
            "text-align": "left", 
            "margin": "0px", 
            "--hover-color": "rgba(0, 0, 0, 00)",  # Made hover color semi-transparent
            "background-color": "transparent"  # Added transparent background
        },
        "nav-link-selected": {
            "background-color": "rgba(0, 0, 0, 0)",  # Made selected background semi-transparent
            "color": "darkorange", 
            "font-size": "17px", 
            "text-align": "left", 
            "margin": "0px"
    ...
    with st.container():
        ...
        with m:
            st.markdown(
                social_icons(30, 30, Youtube=youtube_url, LinkedIn=linkedin_url, GitHub=github_url, Email=email_url),
...
if choose == "Education":
    st.markdown("""<style>.centered {text-align: center;}</style>""", unsafe_allow_html=True)
    st.markdown('<h1 class = "centered">Education</h1>', unsafe_allow_html=True)
    st.write("###")
...
# Print the Base64 st\ring (use it in HTML)
        return  base64_string
    schools = ['<p style="font-size:110%; text-align:center;"><b>Lycée Ibn Al-atir</b></p>', '<p style="font-size:110%;"><b>Ecole Supérieure de Technologie de Salé</b></p> ', '<p style="font-size:110%;"><b>Cycle Préparatoire Ensa Tétouan</b></p>', '<p style="font-size:110%;"><b>Cycle D\'ingénieur Ensa Tétouan</b></p>']
    images = ["C:/Users/aligu/Desktop/else/portfolio/schoolimage/lycee.jpg", "C:/Users/aligu/Desktop/else/portfolio/schoolimage/est.jpg", "C:/Users/aligu/Desktop/else/portfolio/schoolimage/ensa.jpg", "C:/Users/aligu/Desktop/else/portfolio/schoolimage/ensa.jpg"]
    text = ["<p><b>Bac Sciences Physiques</b></p>", "<p><b>Génie civil </b></p>", "<p><b>Deux Années Preparatoire</b></p>","<p><b>Sciences des Données, Big Data & Intelligence Artificielle</b></p>"]
    duration = ["<p><b>2017 - 2020</b></p>", "<p><b>2020 - 2021</b></p>", "<p><b>2021 - 2023</b></p>", "<p><b>2023 - 2026</b></p>"]
    school_url = ["","https://www.est.um5.ac.ma/formation/dut-genie-civil","https://ensa-tetouan.ac.ma/annees-preparatoires/" , "https://ensa-tetouan.ac.ma/science-des-donnees-big-data-intelligence-artificielle/"]
    for i in range(1,len(schools)+1):
        n = len(schools)
        profileHTML=f"""
            <div class="col s12 m4 l8" >
    <div class="card horizontal" style="margin: 20px; max-height: 400px;">
        <div class="card-image">
            <img class="responsive-img" src="data:image/jpeg;base64,{image_to_base64(images[-i])}" style="width: 250px; height: 168px; object-fit: cover;">
        </div>
            ...
            <div class="card-content" style="padding: 15px;">
                ...
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col s12 m9">
                        <h6 style="color:gray; font-size: 0.9rem;">Filière : {text[-i]}</h6>
                    </div>
                    <div class="col s12 m3">
                        <h6 style="color:gray; font-size: 0.9rem;">Durée : {duration[-i]}</h6>
                    </div>
                </div>
            </div>
...
if choose == "Projects":
    ...
    st.markdown("""<style>.centered {text-align: center;}</style>""", unsafe_allow_html=True)
    st.markdown('<h1 class = "centered">Projects</h1>', unsafe_allow_html=True)
    st.divider()
...
if choose == 'Competitions':
    ...
    with st.container():
        ...
        with c1:
            st.image("hackathontange.jpg") #, width=300)
...
if choose == "Technical Skills":

    st.html('<h2 style="text-align:center;">Technical Skills</h2>')
    st.write("###")
    competences = [
